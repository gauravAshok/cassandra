...
public class TimeOrderedKeyCompactionStrategy extends AbstractCompactionStrategy
{
    ...
    {
        return ImmutableSet.copyOf(sstables.keySet());
    }
    ...
    class CategorizedSSTables
    {
        ...
        public CategorizedSSTables(Collection<SSTableStats> data,
                                   Collection<SSTableStats> expiredTombstones,
                                   Collection<SSTableStats> nearExpiryTombstones,
                                   Collection<SSTableStats> latestTombstones,
                                   OverallStats stats)
        {
            this.data = data;
        ...
        public int estimateRemainingTasksBasedOnOverlaps()
        {
            ...
            List<Predicate<OverlappingSet>> filters = Arrays.asList(this::canMergeData, this::canMergeExpiredTombstones, this::canMergeNearExpiryTombstones,
                                                                    this::canMergeLatestTombstones);
