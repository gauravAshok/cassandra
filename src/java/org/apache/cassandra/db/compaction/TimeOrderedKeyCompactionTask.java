...
public class TimeOrderedKeyCompactionTask extends CompactionTask
{
    ...
    public TimeOrderedKeyCompactionTask(ColumnFamilyStore cfs, LifecycleTransaction txn, int gcBefore, TimeOrderedKeyCompactionStrategyOptions options,
    ...
    {
        return tombstoneOnlyMerge ? SSTable.TOMBSTONE_SSTABLE_LVL : SSTable.DATA_SSTABLE_LVL;
    }
}
